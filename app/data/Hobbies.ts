...
export const HOBBIES: ProfileOptions = [
  {
    ...
    label: "Handmade",
    children: [
      { id: "0_0", slug: "handmade", label: "Handmade" },
      { id: "0_1", slug: "diamondMosaic", label: "Алмазная мозайка" },
      { id: "0_2", slug: "batik", label: "Батик" },
      { id: "0_3", slug: "beadCraft", label: "Бисероплетение" },
      { id: "0_4", slug: "brooches", label: "Броши" },
      { id: "0_5", slug: "pyrography", label: "Выжигание" },
      { id: "0_6", slug: "crystalGrowing", label: "Выращивание кристаллов" },
      { id: "0_7", slug: "knitting", label: "Вязание" },
      { id: "0_8", slug: "pottery", label: "Гончарное дело" },
      {
        id: "0_9",
        slug: "decorativeCanning",
        label: "Декоративное консервирование",
      },
      { id: "0_10", slug: "decoupage", label: "Декупаж" },
      { id: "0_11", slug: "candleMaking", label: "Изготовление свечей" },
      { id: "0_12", slug: "jewelryMaking", label: "Изготовление украшений" },
      { id: "0_13", slug: "isography", label: "Изографика" },
      { id: "0_14", slug: "isonit", label: "Изонить" },
      { id: "0_15", slug: "ikebana", label: "Икебана" },
      { id: "0_16", slug: "kanzashi", label: "Канзаши" },
      { id: "0_17", slug: "carving", label: "Карвинг - резьба" },
      { id: "0_18", slug: "customizing", label: "Кастомайзинг" },
      { id: "0_19", slug: "quilling", label: "Квиллинг" },
      { id: "0_20", slug: "rugWeaving", label: "Ковроплетение" },
      { id: "0_21", slug: "lace", label: "Кружево" },
      { id: "0_22", slug: "blacksmithing", label: "Кузнечное дело" },
      { id: "0_23", slug: "dolls", label: "Куклы" },
      { id: "0_24", slug: "wickerwork", label: "Лозоплетение" },
      { id: "0_25", slug: "macrame", label: "Макраме" },
      { id: "0_26", slug: "soapMaking", label: "Мыловарение" },
      { id: "0_27", slug: "origami", label: "Оригами" },
      { id: "0_28", slug: "patchwork", label: "Пэчворк" },
      { id: "0_29", slug: "gingerbreadPainting", label: "Роспись пряников" },
      { id: "0_30", slug: "sweetDesign", label: "Свит-дизайн" },
      { id: "0_31", slug: "scrapbooking", label: "Скрапбукинг" },
      {
        id: "0_32",
        slug: "buildingConstructionSets",
        label: "Собирать конструктор",
      },
      {
        id: "0_33",
        slug: "creatingMetalProducts",
        label: "Создание изделий из металла",
      },
      {
        id: "0_34",
        slug: "creatingMiniatureCarModels",
        label: "Создание мини-копий машин",
      },
      { id: "0_35", slug: "stringArt", label: "Стринг Арт" },
      { id: "0_36", slug: "taxidermy", label: "Таксидермия" },
      { id: "0_37", slug: "twisting", label: "Твистинг" },
      { id: "0_38", slug: "topiary", label: "Топиарии" },
      { id: "0_39", slug: "felting", label: "Фелтинг" },
      { id: "0_40", slug: "sewing", label: "Шитье" },
    ],
  },
  {
    id: "1",
    ...
    label: "Рисование",
    children: [
      { id: "1_0", slug: "painting", label: "Рисование" },
      { id: "1_1", slug: "bodyArt", label: "Бодиарт" },
      { id: "1_2", slug: "bodyPainting", label: "Бодипейнтинг" },
      { id: "1_3", slug: "stainedGlassPainting", label: "Витражная живопись" },
      { id: "1_4", slug: "graffiti", label: "Графитти" },
      { id: "1_5", slug: "doodlingAndZentangle", label: "Дудлинг и зентангл" },
      { id: "1_6", slug: "painting", label: "Живопись" },
      { id: "1_7", slug: "iconography", label: "Иконография" },
      { id: "1_8", slug: "iconPainting", label: "Иконопись" },
      { id: "1_9", slug: "calligraphy", label: "Каллиграфия" },
      { id: "1_10", slug: "blotPainting", label: "Кляксография" },
      { id: "1_11", slug: "marbling", label: "Марблинг" },
      { id: "1_12", slug: "mehndi", label: "Мехенди" },
      { id: "1_13", slug: "mosaic", label: "Мозаика" },
      { id: "1_14", slug: "monotype", label: "Монотипия" },
      { id: "1_15", slug: "threadGraphics", label: "Ниткография" },
      {
        id: "1_16",
        slug: "rightHemisphereDrawing",
        label: "Правополушарное рисование",
      },
      { id: "1_17", slug: "sandDrawing", label: "Рисование песком" },
      { id: "1_18", slug: "glassPainting", label: "Роспись стекла" },
      { id: "1_19", slug: "sketching", label: "Скетчинг" },
      { id: "1_20", slug: "temariArt", label: "Темари арт" },
      { id: "1_21", slug: "facePainting", label: "Фейспеинтинг" },
      { id: "1_22", slug: "freezlight", label: "Фризлайт" },
      { id: "1_23", slug: "ebru", label: "Эбру" },
      { id: "1_24", slug: "encaustic", label: "Энкаустика" },
    ],
  },
  {
    id: "2",
  ...
  },
  {
    ...
    children: [
      ...
      { id: "7_6", slug: "singing", label: "Пение" },
      {
        ...
        label: "Создание музыки и ритмов",
      },
      {
        id: "7_8",
        slug: "songLyricsAndPoetry",
        label: "Тексты и стихи для песен",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    children: [
      ...
      { id: "9_1", slug: "acrobaticDance", label: "Акробатические танцы" },
      {
        ...
        label: "Акробатический рок-н-рол",
      },
      ...
      { id: "9_26", slug: "shaabiDance", label: "Шааби" },
      {
        ...
        label: "Народные(этнические) танцы",
      },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "12_8", slug: "nailArt", label: "Нейл-арт" },
      {
        ...
        label: "Парикмахерское искусство",
      },
      ...
      { id: "12_11", slug: "nordicWalking", label: "Скандинавская ходьба" },
      {
        ...
        label: "Создание уходовой косметики",
      },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "13_8", slug: "sportsGymnastics", label: "Гимнастика спортивная" },
      {
        ...
        label: "Гимнастика художественная",
      },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "16_23", slug: "swimmingWithSharks", label: "Плавание с акулами" },
      {
        ...
        label: "Полёты на воздушных шарах",
      },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "18_2", slug: "winemaking", label: "Виноделие" },
      {
        ...
        label: "Выпечка тортов и десертов",
      },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "23_3", slug: "arVrTechnologies", label: "AR/VR технологии" },
      {
        ...
        label: "IT-технологии и инновации",
      },
      ...
      { id: "23_8", slug: "gameProgramming", label: "Программирование игр" },
      {
        id: "23_9",
        slug: "appDevelopment",
        label: "Программирование приложений",
      },
  ...
  },
  {
    ...
    slug: "blog",
    label: "Блогинг",
    children: [{ id: "24_0", slug: "blog", label: "Блогинг" }],
  },
  {
    id: "25",
    slug: "gambling",
  ...
  },
  {
    ...
    children: [
      ...
      { id: "26_9", slug: "miniatureGames", label: "Игры миниатюр" },
      {
        ...
        label: "Игры с карандашом и бумагой",
      },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "27_2", slug: "figure8Racing", label: "Figure 8 Racing" },
      {
        ...
        label: "Авто и мотогонки на льду",
      },
      ...
      },
      {
        ...
        label: "Гонки на снегоходе по воде",
      },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "33_7", slug: "americanBulldog", label: "Американский бульдог" },
      {
        ...
        label: "Американский голый терьер",
      },
      {
        id: "33_9",
      ...
      },
      {
        ...
        label: "Американский питбультерьер",
      },
      {
        id: "33_11",
        slug: "americanStaffordshireTerrier",
        label: "Американский стаффордширский терьер",
      },
      {
        id: "33_12",
        slug: "americanEskimoDog",
        label: "Американский эскимосский шпиц",
      },
      { id: "33_13", slug: "englishBulldog", label: "Английский бульдог" },
      {
        id: "33_14",
        slug: "englishCockerSpaniel",
        label: "Английский кокер-спаниель",
      },
      ...
      { id: "33_16", slug: "englishSetter", label: "Английский сеттер" },
      {
        ...
        label: "Английский спрингер-спаниель",
      },
      ...
      { id: "33_23", slug: "bedlingtonTerrier", label: "Бедлингтон-терьер" },
      {
        ...
        label: "Белая швейцарская овчарка",
      },
      ...
      { id: "33_42", slug: "welshTerrier", label: "Вельштерьер" },
      {
        ...
        label: "Венгерская выжла (легавая)",
      },
      ...
      },
      {
        ...
        label: "Восточно-сибирская лайка",
      },
      {
        id: "33_47",
        slug: "eastEuropeanShepherd",
        label: "Восточноевропейская овчарка",
      },
      {
        id: "33_48",
        slug: "pyreneanMountainDog",
        label: "Горная пиренейская собака",
      },
      ...
      { id: "33_52", slug: "doberman", label: "Доберман" },
      {
        id: "33_53",
        slug: "drahthaar",
        label: "Дратхаар или немецкая жесткошерстная легавая",
      },
      { id: "33_54", slug: "eurasier", label: "Евразиер" },
      {
        id: "33_55",
        slug: "westSiberianLaika",
        label: "Западно-сибирская лайка",
      },
      ...
      { id: "33_57", slug: "irishWolfhound", label: "Ирландский волкодав" },
      {
        ...
        label: "Ирландский мягкошерстный пшеничный терьер",
      },
      ...
      { id: "33_60", slug: "irishTerrier", label: "Ирландский терьер" },
      {
        ...
        label: "Итальянская болонка (болоньез, болонский бишон)",
      },
      {
        id: "33_62",
        slug: "italianGreyhound",
        label: "Итальянская лавретка (итальянская борзая)",
      },
      ...
      { id: "33_84", slug: "neapolitanMastiff", label: "Мастино наполетано" },
      {
        ...
        label: "Мексиканская голая собака (ксоло)",
      },
      ...
      { id: "33_90", slug: "germanMastiff", label: "Немецкий дог" },
      {
        ...
        label: "Немецкий ягдтерьер",
      },
      {
        id: "33_92",
        slug: "novaScotiaDuckTollingRetriever",
        label: "Новошотландский ретривер (толлер)",
      },
      ...
      { id: "33_107", slug: "russianBorzoi", label: "Русская псовая борзая" },
      {
        ...
        label: "Русская салонная собака (русалка)",
      },
      {
        id: "33_109",
        slug: "russianSpaniel",
        label: "Русский охотничий спаниель",
      },
      { id: "33_110", slug: "russianToyTerrier", label: "Русский той-терьер" },
      {
        id: "33_111",
        slug: "blackRussianTerrier",
        label: "Русский черный терьер",
      },
      ...
      { id: "33_117", slug: "scottishTerrier", label: "Скотч-терьер" },
      {
        ...
        label: "Среднеазиатская овчарка (алабай)",
      },
      {
        id: "33_119",
        slug: "staffordshireBullTerrier",
        label: "Стаффордширский бультерьер",
      },
      ...
      { id: "33_134", slug: "chowChow", label: "Чау-чау" },
      {
        ...
        label: "Чесапик-бей-ретривер",
      },
      {
        id: "33_136",
        slug: "czechoslovakianWolfhound",
        label: "Чехословацкая волчья",
      },
      ...
      { id: "33_144", slug: "schipperke", label: "Шипперке" },
      {
        id: "33_145",
        slug: "scottishSetter",
        label: "Шотландский сеттер (гордон)",
      },
      ...
      { id: "33_147", slug: "estonianHound", label: "Эстонская гончая" },
      {
        ...
        label: "Южноафриканский бурбуль",
      },
      {
        id: "33_149",
        slug: "southRussianOvcharka",
        label: "Южнорусская овчарка",
      },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "34_3", slug: "asianTabby", label: "Азиатская (табби)" },
      {
        ...
        label: "Американсая жесткошерсная",
      },
      {
        id: "34_5",
        slug: "americanShorthair",
        label: "Американская короткошерстная",
      },
      {
        id: "34_6",
        slug: "americanBobtailShorthair",
        label: "Американский бобтей короткошерстный",
      },
      {
        id: "34_7",
        slug: "americanBobtailLonghair",
        label: "Американский бобтейл длинношерстный",
      },
      {
        id: "34_8",
        slug: "americanCurlLonghair",
        label: "Американский кёрл длинношерстный",
      },
      {
        id: "34_9",
        slug: "americanCurlShorthair",
        label: "Американский кёрл короткошерстный",
      },
      ...
      { id: "34_14", slug: "bombay", label: "Бомбейная" },
      {
        ...
        label: "Бразильская короткошерстная",
      },
      {
        id: "34_16",
        slug: "britishLonghair",
        label: "Британская длинношерстная",
      },
      {
        id: "34_17",
        slug: "britishShorthair",
        label: "Британская короткошерстная",
      },
      { id: "34_18", slug: "burmese", label: "Бурманская" },
      {
        id: "34_19",
        slug: "burmillaLonghair",
        label: "Бурмилла длинношерстный",
      },
      {
        id: "34_20",
        slug: "burmillaShorthair",
        label: "Бурмилла короткошерстный",
      },
      ...
      { id: "34_28", slug: "kaani", label: "Каани" },
      {
        ...
        label: "Калифорнийская сияющая",
      },
      {
        id: "34_30",
        slug: "karelianBobtailLonghair",
        label: "Карельский бобтейл длинношерстный",
      },
      {
        id: "34_31",
        slug: "karelianBobtailShorthair",
        label: "Карельский бобтейл короткошерстный",
      },
      ...
      { id: "34_37", slug: "kurilianBobtail", label: "Курильский бобтейл" },
      {
        ...
        label: "Курильский бобтейл длинношерстный",
      },
      {
        id: "34_39",
        slug: "kurilianBobtailShorthair",
        label: "Курильский бобтейл короткошерстный",
      },
      ...
      { id: "34_41", slug: "lapermShorthair", label: "Лаперм короткошерстный" },
      {
        ...
        label: "Манчкин длинношерстный",
      },
      {
        id: "34_43",
        slug: "munchkinShorthair",
        label: "Манчкин короткошерстная",
      },
      ...
      { id: "34_53", slug: "oregonRex", label: "Орегон рекс" },
      {
        ...
        label: "Ориентальная длинношерстная",
      },
      {
        id: "34_55",
        slug: "orientalShorthair",
        label: "Ориентальная короткошерстная",
      },
      { id: "34_56", slug: "ochosAzules", label: "Охос азулес" },
      {
        id: "34_57",
        slug: "ochosAzulesLonghair",
        label: "Охос азулес длинношерстный",
      },
      ...
      { id: "34_60", slug: "peterbald", label: "Петерболд" },
      {
        ...
        label: "Пиксибоб длинношерстный",
      },
      {
        id: "34_62",
        slug: "pixiebobShorthair",
        label: "Пиксибоб короткошерстный",
      },
      ...
      { id: "34_68", slug: "sacredBirman", label: "Священная бирманская" },
      {
        ...
        label: "Сейшельская длинношерстная",
      },
      {
        id: "34_70",
        slug: "seychelloisShorthair",
        label: "Сейшельская короткошерстная",
      },
      {
        id: "34_71",
        slug: "selkirkRexLonghair",
        label: "Селкирк рекс длинношерстный",
      },
      {
        id: "34_72",
        slug: "selkirkRexShorthair",
        label: "Селкирк рекс короткошерстный",
      },
      ...
      { id: "34_86", slug: "ukrainianLevkoy", label: "Украинский левкой" },
      {
        ...
        label: "Уральский рекс длинношерстный",
      },
      {
        id: "34_88",
        slug: "uralRexShorthair",
        label: "Уральский рекс короткошерстный",
      },
      ...
      { id: "34_95", slug: "javanese", label: "Яванез" },
      {
        ...
        label: "Японский бобтейл длинношерстный",
      },
      {
        id: "34_97",
        slug: "japaneseBobtailShorthair",
        label: "Японский бобтейл короткошерстный",
      },
    ],
  },
  {
    ...
    children: [
      ...
      { id: "35_3", slug: "childrensBooks", label: "Детские книги" },
      {
        ...
        label: "Детские развивающие игры",
      },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "38_15", slug: "cosmetology", label: "Косметология" },
      {
        ...
        label: "Консалтинг, бухгалтерия, юриспруденция",
      },
      ...
      { id: "38_29", slug: "animalBreeding", label: "Разведение животных" },
      {
        ...
        label: "Разработка настольных игр",
      },
      {
        id: "38_31",
      ...
      { id: "38_37", slug: "tourism", label: "Туризм" },
      {
        ...
        label: "Услуги и товары для животных",
      },
  ...
  },
  {
    ...
    children: [
      ...
      { id: "41_5", slug: "bookophilia", label: "Книгофилия" },
      {
        id: "41_6",
        slug: "artCollecting",
        label: "Коллекционирование предметов исскуства",
      },
      {
        id: "41_7",
        slug: "collectingVariousGroups",
        label: "Коллекционирование разных групп",
      },
